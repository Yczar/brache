...
import 'package:brache_cli/src/command_runner.dart';
...
void main() {
  group('BracheCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late BracheCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = BracheCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = BracheCliCommandRunner();
